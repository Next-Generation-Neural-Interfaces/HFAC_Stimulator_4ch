...
typedef enum _edma_channel_link_type
{
    ...
    kEDMA_MinorMajorLink,  /*!< Channel link for every channel activation */
...
typedef enum _edma_transfer_type
{
    ...
    kEDMA_PeripheralToPeripheral /*!< Transfer from peripheral to peripheral (i.e. no source/dest offset between transfers) */
