...
%Stimulation (biphasic symmetric) parameters channel 1
stimChannel_1 = 0;
stim_PW_1 = 300; %(us)
stim_amp_1 = -2000; %(uA)
stim_interphase = 20; %(us)
stim_PW_2 = 300; %(us)
stim_amp_2 = 2000; %(uA)
stim_rep = 60; %repetitions
uartBaudRate = 115200;

stim_interpulse = 1000000-stim_PW_1-stim_PW_2-stim_interphase;
