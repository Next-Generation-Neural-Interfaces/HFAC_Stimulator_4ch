...
%PC system.
amplitude = -500; %Pulse Amplitude in microamps (uA)
pulse_width = 300; %Pulse Width in microseconds (us)
...
channel = 1; %Channel to use for stimulation
dummy = 0; %1 = output to dummy, for debug purposes
%END PARAMETERS
...
stim_interpulse = interpulse*1000000-pulse_width;
...
pause(repetitions*interpulse+pulse_width/1000000+0.2)
