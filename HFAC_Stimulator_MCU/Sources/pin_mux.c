...
{
  BOARD_InitLEDsPins(); //This initializes all three leds
  ...
  PORT_SetPinMux(PORTD, PIN0_IDX, kPORT_MuxAlt2);            /* PORTD0 (pin 93) is configured as SPI0_PCS0 (SPI-driven octal switches)*/
  ...
  PORT_SetPinMux(PORTC, PIN3_IDX, kPORT_MuxAlt2);            /* PORTC3 (pin 73) is configured as SPI0_PCS1 (External DAC)*/
  PORT_SetPinMux(PORTC, PIN2_IDX, kPORT_MuxAlt2);            /* PORTC2 (pin 72) is configured as SPI0_PCS2 (External ADC)*/
  PORT_SetPinMux(PORTA, PIN1_IDX, kPORT_MuxAsGpio);          /* PORTA1 (pin 35) is configured as GPIO (6ch SPI digital isolator)*/
  PORT_SetPinMux(PORTA, PIN2_IDX, kPORT_MuxAsGpio);          /* PORTA2 (pin 36) is configured as GPIO (4ch UART digital isolator)*/

  //Stimulation trigger signal GPIOs
  PORT_SetPinMux(PORTC, PIN0_IDX, kPORT_MuxAsGpio);            /* PORTC0 (pin 70) is configured as GPIO (stim trigger ch2)*/
  PORT_SetPinMux(PORTC, PIN5_IDX, kPORT_MuxAsGpio);            /* PORTC5 (pin 77) is configured as GPIO (stim trigger ch0)*/
  PORT_SetPinMux(PORTC, PIN7_IDX, kPORT_MuxAsGpio);            /* PORTC7 (pin 79) is configured as GPIO (stim trigger ch1)*/
  PORT_SetPinMux(PORTC, PIN9_IDX, kPORT_MuxAsGpio);            /* PORTC9 (pin 81) is configured as GPIO (stim trigger ch3)*/
